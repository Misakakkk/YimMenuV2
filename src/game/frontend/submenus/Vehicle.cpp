...
namespace YimMenu::Submenus
{
	Vehicle::Vehicle() :
	    ...
	    Submenu::Submenu("载具选项", ICON_FA_CAR)
	{
		...
		globals->AddItem(std::make_shared<BoolCommandItem>("vehiclegodmode"_J, "载具无敌"));
		globals->AddItem(std::make_shared<BoolCommandItem>("keepfixed"_J, "自动修复"));
		...
		misc->AddItem(std::make_shared<BoolCommandItem>("lowervehiclestance"_J, "降低载具姿态"));
